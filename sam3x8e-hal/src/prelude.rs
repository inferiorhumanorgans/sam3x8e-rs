...
pub use crate::{delay::*, efc::{Config as EfcConfig, Efc0Ext, Efc1Ext}, gpio::GpioExt as _, time::U32Ext as _, timer::TimerExt as _, pmc::PmcExt as _, watchdog::WatchdogExt as _};
